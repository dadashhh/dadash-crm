-- ═══════════════════════════════════════════════════════════════════════════════
-- v_spenders_ui — Ajout de personality_notes
-- Date: 2026-03-04
-- Objectif: exposer personality_notes dans la vue stable pour la fiche spender,
--           utilisé dans la section "ANALYSE IA" de l'onglet Profil (CRM).
--           Fallback depuis meta->'profile'->'personality_notes' si colonne NULL.
-- ═══════════════════════════════════════════════════════════════════════════════
