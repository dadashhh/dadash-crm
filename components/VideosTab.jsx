...
const VideosTab = ({user, lang, models, modelVideos, videoSessions, dbSpenders, onRefresh}) => {
  ...
  const subTabs = [
    {id:"library", label:lang==="fr"?"Bibliothèque":"Library", icon:"📚"},
  ...
  return React.createElement("div",{className:"tab-content"},
    ...
    React.createElement("div",{className:"tab-header",style:{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}},
      React.createElement("h2",{className:"tab-title",style:{margin:0}},"\u{1F4F9} ",lang==="fr"?"Vidéos":"Videos"),
    ...
    subTab==="library" && React.createElement(React.Fragment,null,
      ...
      React.createElement("div",{className:"kpi-row",style:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:16,margin:"20px 0"}},
        [{label:lang==="fr"?"Total vidéos":"Total Videos",value:libKPIs.total,icon:"🎥"},{label:lang==="fr"?"Vidéos/modèle (moy)":"Videos/model (avg)",value:libKPIs.avgPerModel,icon:"📊"},{label:"Sessions totales",value:libKPIs.totalSessions,icon:"🎬"},{label:lang==="fr"?"CA généré":"Revenue Generated",value:fmtEUR(libKPIs.totalCA),icon:"💰"}].map((k,i)=>
      ...
      React.createElement("div",{style:{display:"flex",gap:12,alignItems:"center",flexWrap:"wrap",marginBottom:16}},
        React.createElement("select",{className:"input",value:filterModel,onChange:e=>setFilterModel(e.target.value),style:{maxWidth:180}},
          React.createElement("option",{value:""},lang==="fr"?"Tous les modèles":"All Models"),
        ...
        React.createElement("select",{className:"input",value:filterType,onChange:e=>setFilterType(e.target.value),style:{maxWidth:160}},
          React.createElement("option",{value:""},lang==="fr"?"Tout type":"All Types"),
          contentTypes.map(t=>React.createElement("option",{key:t,value:t},t.charAt(0).toUpperCase()+t.slice(1)))
        ),
        React.createElement("input",{className:"input",placeholder:lang==="fr"?"Rechercher...":"Search...",value:searchQ,onChange:e=>setSearchQ(e.target.value),style:{maxWidth:200}}),
        React.createElement("div",{style:{flex:1}}),
        React.createElement("button",{className:"btn btn-primary",onClick:()=>setShowAddModal(true)},"➕ ",lang==="fr"?"Ajouter une vidéo":"Add Video")
      ),
      ...
      filteredVideos.length===0 && React.createElement("div",{style:{textAlign:"center",padding:40,color:"var(--text-tertiary)"}},lang==="fr"?"Aucune vidéo trouvée":"No videos found")
    ),
    ...
    subTab==="sessions" && React.createElement(React.Fragment,null,
      // KPIs
      React.createElement("div",{className:"kpi-row",style:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:16,margin:"20px 0"}},
        [{label:lang==="fr"?"Sessions aujourd'hui":"Sessions Today",value:sessKPIs.todaySess,icon:"📅"},{label:lang==="fr"?"CA vidéo ce mois":"Video Revenue (month)",value:fmtEUR(sessKPIs.monthCA),icon:"💰"},{label:lang==="fr"?"Durée moyenne":"Avg Duration",value:fmtDuration(sessKPIs.avgDur),icon:"⏱"},{label:lang==="fr"?"Taux de succès":"Success Rate",value:sessKPIs.successRate+"%",icon:"✅"}].map((k,i)=>
          React.createElement("div",{key:i,className:"card",style:{padding:16,display:"flex",alignItems:"center",gap:12}},
            React.createElement("div",{style:{fontSize:28}},k.icon),
            React.createElement("div",null,
              React.createElement("div",{style:{color:"var(--text-tertiary)",fontSize:12,marginBottom:2}},k.label),
      ...
      React.createElement("div",{style:{display:"flex",gap:12,alignItems:"center",flexWrap:"wrap",marginBottom:16}},
        React.createElement("select",{className:"input",value:filterPeriod,onChange:e=>setFilterPeriod(e.target.value),style:{maxWidth:140}},
          ...
          React.createElement("option",{value:"all"},lang==="fr"?"Tout":"All")
        ),
        React.createElement("select",{className:"input",value:filterModel,onChange:e=>setFilterModel(e.target.value),style:{maxWidth:180}},
          React.createElement("option",{value:""},lang==="fr"?"Tous les modèles":"All Models"),
          models.map(m=>React.createElement("option",{key:m.id,value:m.id},m.name))
        ...
        React.createElement("select",{className:"input",value:filterStatus,onChange:e=>setFilterStatus(e.target.value),style:{maxWidth:160}},
          React.createElement("option",{value:""},lang==="fr"?"Tout status":"All Status"),
      ...
      React.createElement("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:16}},
        ...
        React.createElement("div",{className:"card",style:{padding:16}},
          React.createElement("h4",{style:{margin:"0 0 12px",color:"var(--text-primary)",fontSize:14}},"🔥 ",lang==="fr"?"Vidéos les plus jouées":"Most Played Videos"),
          topPlayed.length===0
            ? React.createElement("div",{style:{color:"var(--text-tertiary)",fontSize:13}},lang==="fr"?"Aucune donnée":"No data")
        ...
        // Top clients
        React.createElement("div",{className:"card",style:{padding:16}},
          React.createElement("h4",{style:{margin:"0 0 12px",color:"var(--text-primary)",fontSize:14}},"👥 ",lang==="fr"?"Clients les plus actifs":"Most Active Clients"),
          topClients.length===0
            ? React.createElement("div",{style:{color:"var(--text-tertiary)",fontSize:13}},lang==="fr"?"Aucune donnée":"No data")
      ...
      React.createElement("div",{className:"card",style:{overflow:"auto"}},
        React.createElement("table",{className:"data-table",style:{width:"100%"}},
          React.createElement("thead",null,
            React.createElement("tr",null,
              ...
              React.createElement("th",null,lang==="fr"?"Modèle":"Model"),
              React.createElement("th",null,"Client"),
              React.createElement("th",null,lang==="fr"?"Vidéo":"Video"),
              React.createElement(SortTh,{label:lang==="fr"?"Durée payée":"Paid Duration",sortKey:"duration_paid",sort,onSort}),
              React.createElement(SortTh,{label:lang==="fr"?"Durée réelle":"Real Duration",sortKey:"duration_real",sort,onSort}),
              React.createElement(SortTh,{label:lang==="fr"?"Montant":"Amount",sortKey:"amount",sort,onSort}),
        ...
        filteredSessions.length===0 && React.createElement("div",{style:{textAlign:"center",padding:32,color:"var(--text-tertiary)"}},lang==="fr"?"Aucune session trouvée":"No sessions found")
      )
    ),
    ...
    subTab==="analytics" && React.createElement(React.Fragment,null,
      React.createElement("div",{style:{marginTop:20}},
        ...
        contentAlerts.length>0 && React.createElement("div",{style:{background:"var(--danger)",borderRadius:10,padding:"12px 16px",marginBottom:20,color:"#fff"}},
          React.createElement("strong",null,"🚨 ",lang==="fr"?"Alertes contenu":"Content Alerts"),
          contentAlerts.map((a,i)=>React.createElement("div",{key:i,style:{marginTop:6,fontSize:13}},"• ",a.client," ",lang==="fr"?"a vu toutes les vidéos de":"has watched all videos from"," ",React.createElement("strong",null,a.model)," → ",lang==="fr"?"besoin de nouveau contenu":"needs new content"))
        ),
        ...
        React.createElement("div",{className:"card",style:{padding:16,marginBottom:20}},
          ...
          topVideosByPlay.length===0
            ? React.createElement("div",{style:{color:"var(--text-tertiary)"}},lang==="fr"?"Aucune donnée":"No data")
        ...
        React.createElement("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:20}},
          ...
          React.createElement("div",{className:"card",style:{padding:16}},
            React.createElement("h4",{style:{margin:"0 0 16px",color:"var(--text-primary)"}},"📊 ",lang==="fr"?"Répartition par type":"Distribution by Type"),
            rechartsReady && PieChart && typeDistribution.length>0
              ...
              : React.createElement("div",{style:{height:260,display:"flex",alignItems:"center",justifyContent:"center",color:"var(--text-tertiary)"}},lang==="fr"?"Aucune donnée":"No data")
          ),
    ...
    showAddModal && React.createElement("div",{className:"modal-overlay",onClick:()=>setShowAddModal(false)},
      React.createElement("div",{className:"modal",onClick:e=>e.stopPropagation(),style:{maxWidth:520}},
        React.createElement("div",{className:"modal-header"},
          React.createElement("h3",{style:{margin:0}},"➕ ",lang==="fr"?"Ajouter une vidéo":"Add Video"),
        ...
        React.createElement("div",{className:"modal-body",style:{display:"flex",flexDirection:"column",gap:14}},
          // Select modèle
          React.createElement("div",null,
            React.createElement("label",{style:{fontSize:12,color:"var(--text-secondary)",marginBottom:4,display:"block"}},lang==="fr"?"Modèle *":"Model *"),
            React.createElement("select",{className:"input",value:formModel,onChange:e=>setFormModel(e.target.value),style:{width:"100%"}},
              React.createElement("option",{value:""},lang==="fr"?"Choisir un modèle":"Choose a model"),
              models.map(m=>React.createElement("option",{key:m.id,value:m.id},m.name))
            )
          ),
          // Titre
          React.createElement("div",null,
            React.createElement("label",{style:{fontSize:12,color:"var(--text-secondary)",marginBottom:4,display:"block"}},lang==="fr"?"Titre *":"Title *"),
            React.createElement("input",{className:"input",value:formTitle,onChange:e=>setFormTitle(e.target.value),placeholder:lang==="fr"?"Nom de la vidéo":"Video name",style:{width:"100%"}})
          ),
          // Upload fichier
          React.createElement("div",null,
            React.createElement("label",{style:{fontSize:12,color:"var(--text-secondary)",marginBottom:4,display:"block"}},lang==="fr"?"Fichier vidéo":"Video File"),
            React.createElement("input",{type:"file",accept:"video/*",onChange:handleFileSelect,style:{fontSize:13,color:"var(--text-primary)"}}),
            formDuration>0 && React.createElement("span",{style:{fontSize:12,color:"var(--text-tertiary)",marginLeft:8}},lang==="fr"?"Durée détectée : ":"Detected duration: ",fmtDuration(formDuration))
          ),
          // Type de contenu
          ...
          React.createElement("div",null,
            ...
            React.createElement("textarea",{className:"input",value:formDesc,onChange:e=>setFormDesc(e.target.value),rows:3,placeholder:lang==="fr"?"Description optionnelle":"Optional description",style:{width:"100%",resize:"vertical"}})
          )
        ),
        React.createElement("div",{className:"modal-footer",style:{display:"flex",justifyContent:"flex-end",gap:8,paddingTop:12}},
          React.createElement("button",{className:"btn btn-ghost",onClick:()=>setShowAddModal(false)},lang==="fr"?"Annuler":"Cancel"),
          React.createElement("button",{className:"btn btn-primary",onClick:handleAddVideo,disabled:uploading||!formModel||!formTitle},uploading?(lang==="fr"?"Upload en cours...":"Uploading..."):(lang==="fr"?"Ajouter":"Add"))
        )
      )
    )
  );
